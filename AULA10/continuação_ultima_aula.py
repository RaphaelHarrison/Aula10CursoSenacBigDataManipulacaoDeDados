...
try:
    ...
    if len(df_roubo_veiculo_outliers_inferiores) > 0:
        df_roubo_veiculo_outliers_inferiores = (df_roubo_veiculo_outliers_inferiores.sort_values(by="roubo_veiculo", ascending=True))
        ...
        plt.title("Municipios com outliers inferiores")

...
try:
    # Assimetria
    # Medida que indica como os dados estão distribuidos em torno do valor central
    # Estão distribuidos em torno do centro?
    # Existe uma quantidade maior de registros maiores sou menores?
    # Para que lado está o peso
    # A medida é usada para descrever o grau de simetria ou assimetria
...
try:
    ...
    plt.title("Boxplot dos Roubos por Municipios")
